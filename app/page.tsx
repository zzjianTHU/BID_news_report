...
export default async function HomePage({ searchParams }: HomePageProps) {
  ...
  const [latestDigest, initialFeedPosts, fallbackFeedPosts, thoughts] = await Promise.all([
    getLatestDigest(),
    getFeedPosts(tag, window),
    window === "24h" ? getFeedPosts(tag, "7d") : Promise.resolve([]),
    getPublishedThoughts()
  ]);
  const feedPosts = initialFeedPosts.length > 0 ? initialFeedPosts : fallbackFeedPosts;
      ...
      <div className="page-body">
        {latestDigest ? (
          ...
          <section className="digest-hero-card">
            ...
            <p className="digest-hero-summary">最新一期还在整理中，稍后会在这里更新。</p>
          </section>
        )}
        ...
        <section className="section-block">
          <div className="section-heading-row">
            <div>
              <p className="section-kicker">最新文章</p>
              <h2>最新情报</h2>
            </div>
          ...
          <div className="feed-list">
            {feedPosts.length > 0 ? (
              ...
              <article className="split-card">
                <p className="section-kicker">暂时还没有</p>
                <h3>新的情报还在整理中</h3>
        ...
        <section className="section-block">
          <div className="section-heading-row">
            <div>
              <p className="section-kicker">专题内容</p>
              <h2>专题 / 思考</h2>
            </div>
